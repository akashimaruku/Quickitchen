    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <span> / </span>
                <span style="font-weight:bold; color:#434343;">Preparation Equipment</span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
                ...
                <h4>Preparation Equipment</h2>

            </div>
            <div class="col-sm-12 col-md-6 col-lg-6 mr-0">
        ...
        <div class="row">
            <?php
                include 'db.php';
                $query = $con->query("select * from qk_products where product_type='Preparation Equipment'");
                while($row = $query->fetch_assoc()){ 
            ?>
            <div class="col-sm-12 col-md-6 col-lg-3">
                <form action=" " class="form-submit">
