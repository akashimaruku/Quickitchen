...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <?php
                include 'db.php';
                $query = $con->query("select * from qk_products where product_type='Cooking Equipment' limit 0,4");
            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
                <form action=" " class="form-submit">
                    ...
                    <div class="fakedesc">
                        ...
                        <span style="font-size:15px; color:#0d47a1; font-weight:bold;">₱<?php echo number_format($row['price'],2);?></span>
        ...
        <div class="row">
            <?php
                include 'db.php';
                $query = $con->query("select * from qk_products where product_type='Food Service Equipment' limit 0,4");
                while($row = $query->fetch_assoc()){ 
            ?>
            <div class="col-sm-12 col-md-6 col-lg-3">
                <form action=" " class="form-submit">
        ...
        <div class="row">
            <?php
                include 'db.php';
                $query = $con->query("select * from qk_products where product_type='Preparation Equipment' limit 0,4");
                while($row = $query->fetch_assoc()){ 
            ?>
            <div class="col-sm-12 col-md-6 col-lg-3">
                <form action=" " class="form-submit">
                    <div class="cfakeimg">
                        <a href="productdetails3.php?id=<?php echo $row['id'];?> &image=<?php echo $row['image'];?> &productname=<?php echo $row['product_name'];?>  
                        &price=<?php echo $row['price'];?> &description=<?php echo $row['description'];?>"> <img src="images/<?php echo $row['image'];?>"
                                class="img-responsive" width="100%"></a>
                    </div>
                    <div class="fakedesc">
                        ...
                        <span
                            style="font-size:15px; color:#0d47a1; font-weight:bold;">₱<?php echo number_format($row['price'],2);?></span>
                        <!--<a href="#" class="float-right btnaddcart additembtn">ADD TO CART</a>-->
                        <button class="btn float-right btnaddcart addItemBtn">ADD TO CART</button>
                    </div>
                    <input type="hidden" class="pid" value="<?php echo $row['id']?>">
                    <input type="hidden" class="pname" value="<?php echo $row['product_name']?>">
