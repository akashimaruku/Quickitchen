        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse " id="basicExampleNav">
                ...
                <ul class="navbar-nav ml-auto w-100 justify-content-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" style="color:#434343; font-weight:bold;">ABOUT US</a>
                    </li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="flex-left flex-column">
                ...
                <h1 style="color:#0d47a1;font-weight:bold; ">About Us</h1>
                ...
                <p class="animated fadeIn text-muted text-left text-justify" style="font-size:20px;">
                    Quickitchen is there to serve at affordable prices the equipment needs for start-up and
                </p>
                <p class="animated fadeIn text-muted text-left text-justify" style="font-size:20px;"> leveling - up food
                    businesses and yes, residentials as well. Kitchen equipment made from </p>
                <p class="animated fadeIn text-muted text-left text-justify" style="font-size:20px;"> stainless steel
                    ensures higher cleanliness, safety and aesthetic standards. Buying </p>
                <p class="animated fadeIn text-muted text-left text-justify" style="font-size:20px;"> Quickitchen
                    equipment is an investment. Yet, Quickitchen's value engineering efforts have </p>
                <p class="animated fadeIn text-muted text-left text-justify" style="font-size:20px;"> seen to it that
                    its prices are indeed still very much affordable. Quickitchen's product lines are </p>
                <p class="animated fadeIn text-muted text-left text-justify" style="font-size:20px;"> preparation
                    equipment, cooking equipment and food service equipment.
                </p>
                <br>
                <br>
            </div>
